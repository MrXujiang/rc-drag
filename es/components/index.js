...
function Drag(props) {
  ...
  useEffect(function () {
    dragBox.current = _typeof(container) === 'object' ? container : document.querySelector(container);
...
export default /*#__PURE__*/memo(Drag);